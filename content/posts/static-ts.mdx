...
<Image src="/static-ts/figure_1.png" width="718" height="404" alt="Image" />
...
<Image src="/static-ts/figure_2.png" width="718" height="404" alt="Image" />
...
<Image src="/static-ts/figure_3.png" width="718" height="404" alt="Image" />
...
<Image src="/static-ts/figure_4.png" width="718" height="404" alt="Image" />
...
<Image src="/static-ts/figure_5.png" width="718" height="404" alt="Image" />

**图 5**：测量三种 MCU 上各种形式的成员访问所需的时间周期，每项形式的操作运行一百万次，然后将测得的平均耗时换算成时间周期。

<Image src="/static-ts/figure_6.png" width="718" height="404" alt="Image" />
...
<Image src="/static-ts/figure_7.png" width="718" height="404" alt="Image" />
